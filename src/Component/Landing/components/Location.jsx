            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/about" className="hover:text-sky-400">
                  <i className="fas fa-map-marker-alt mr-2"></i>FAQs
                </a>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center">
                <i className="fas fa-map-marker-alt mr-2 text-sky-500"></i>363,
                Arcot Rd, Kodambakkam, Chennai, 600024
              </li>
              <li className="flex items-center">
                <i className="fas fa-phone-alt mr-2 text-sky-500"></i>+91 94894
                94643
              </li>
              <li className="flex items-center">
