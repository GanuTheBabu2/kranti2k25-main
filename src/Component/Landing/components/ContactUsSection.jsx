...
function FAQSection() {
  ...
  const faqs = [
    {
      ...
      answer:
        "Yes, food will be provided to all participants. The event organizers have arranged for meals after the event.",
    },
    {
  ...
  return (
    <div 
      ...
      style={{
        background: "linear-gradient(135deg, #000000 0%, #0b0b1a 30%, #13061a 70%, #1a001f 100%)",
